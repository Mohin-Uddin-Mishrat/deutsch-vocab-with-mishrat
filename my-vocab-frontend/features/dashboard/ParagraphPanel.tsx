...
export default function ParagraphPanel({ categoryId, canDelete = false, onNotice }: { categoryId: string; canDelete?: boolean; onNotice?: (message: string) => void }) {
  ...
  return <section className="space-y-5">
    ...
    {wordsParagraph && (
      <div className="fixed inset-0 z-50 lg:hidden" role="dialog" aria-modal="true" aria-label="Used words" onClick={() => setWordsDialogIndex(null)}>
        <div className="fixed top-0 left-0 right-0 h-[50vh] flex flex-col bg-white p-5 border-b border-slate-200 rounded-b-2xl" onClick={(event) => event.stopPropagation()}>
